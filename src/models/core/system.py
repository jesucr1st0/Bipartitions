...
from constants.base import BASE_TWO, COLS_IDX, INT_ZERO
from constants.error import ERROR_ESPACIOS_INCOMPATIBLES
from funcs.iit import reindexar, seleccionar_estado
from models.base.application import aplicacion
from models.core.ncube import NCube
